...
- Diskuter i rapporten: Hva er fordelen med å beholde rådataene i MongoDB selv etter at SQL-databasen er oppdatert? (Hint: tenk på feilsøking, historikk og muligheten for å re-prosessere data.) **dette skal besvares i rapporten*** Kodeforslag for oppgaven blir introdusert på forelesningene i april. 
